...
Please use [divan](https://docs.rs/divan/latest/divan/) to benchmark the performance of the library.
...
### Multifile Patching Performance

```bash
cargo bench --bench multifile_patcher
```

## Divan Example

create `benches/example.rs` and add the following content:
...
Below is an more complex example on how to use:
